...
parser.add_argument('-E', '--tissue-depth', type=zeroplus_int, default=0, help="Depth of tissue, in square cell layers, from the input substance source to the output cell layer. If zero, cells are arranged into a cube.")
