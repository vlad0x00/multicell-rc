...
parser.add_argument('-p', '--strains', type=abovezero_int, default=10, help="Number of strains in the simulation.")
...
parser.add_argument('-a', '--alpha-esm', type=zeroplus_float, default=1.0/45.0, help="Molecular decay rate of ESMs.")
parser.add_argument('-b', '--beta-esm', type=zeroplus_float, default=5.0, help="Grid diffusion coefficient of ESMs.")
parser.add_argument('-y', '--esms', type=zeroplus_int, default=5, help="Number of ESMs in the simulation.")
parser.add_argument('-L', '--secretion-low', type=zeroplus_float, default=1.0, help="Basal ESM secretion when the gene is off.")
parser.add_argument('-H', '--secretion-high', type=zeroplus_float, default=5.0, help="ESM secretion when the gene is on.")
parser.add_argument('-t', '--esm-threshold', type=zeroplus_float, default=11.5, help="ESM threshold to turn a gene on. Value is relative to basal secretion.")
