...
parser.add_argument('-D', '--dirichlet-boundary', type=abovezero_float, default=50.0, help="Value of dirichlet boundary when input signal is on. The value is 0 when the signal is off.")
parser.add_argument('-T', '--input-threshold', type=abovezero_float, default=5.0, help="Threshold for the molecular concentration of input signal for cells to consider it on.")
...
parser.add_argument('-r', '--cell-radius', type=abovezero_float, default=1.0, help="Cell radius.")
parser.add_argument('-x', '--grid-spacing', type=abovezero_float, default=3.0, help="Simulation space voxel edge length.")
