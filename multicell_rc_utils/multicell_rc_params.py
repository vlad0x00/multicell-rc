...
parser.add_argument('-D', '--dirichlet-boundary', type=abovezero_float, default=100000.0, help="Value of dirichlet boundary when input signal is on. The value is 0 when the signal is off.")
parser.add_argument('-T', '--input-threshold', type=abovezero_float, default=1.5, help="Threshold for the molecular concentration of input signal for cells to consider it on.")
parser.add_argument('-A', '--alpha-input', type=zeroplus_float, default=0.2, help="Molecular decay rate of input signal.")
...
parser.add_argument('-a', '--alpha-cytokines', type=zeroplus_float, default=0.1, help="Molecular decay rate of cytokines.")
...
parser.add_argument('-t', '--cytokine-threshold', type=zeroplus_float, default=5.0, help="Cytokine threshold to turn a gene on. Value is relative to basal secretion.")
parser.add_argument('-r', '--cell-radius', type=abovezero_float, default=10.0, help="Cell radius.")
parser.add_argument('-x', '--grid-spacing', type=abovezero_float, default=20.0, help="Simulation space voxel edge length.")
...
parser.add_argument('-d', '--source-dist', type=abovezero_int, default=1, help="Distance between the signal producing wall and tissue.")
