...
parser.add_argument('-c', '--cells', type=abovezero_int, default=384, help="Number of cells in the simulation.")
parser.add_argument('-p', '--cell-types', type=abovezero_int, default=20, help="Number of cell types in the simulation.")
parser.add_argument('-E', '--tissue-depth', type=abovezero_int, default=6, help="Depth of tissue, in square cell layers, from the input substance source to the output cell layer.")
...
parser.add_argument('-C', '--output-cell-fraction', type=fraction_type, default=0.5, help="Fraction of cells used for output.")
parser.add_argument('-P', '--output-cell-type-fraction', type=fraction_type, default=0.05, help="Fraction of cell types used for output.")
...
parser.add_argument('-D', '--dirichlet-boundary', type=abovezero_float, default=2000.0, help="Value of dirichlet boundary when input signal is on. The value is 0 when the signal is off.")
